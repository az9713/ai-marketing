...
This project was inspired by the YouTube video ["These 5 Books Reveal Why Most AI Products Don't Sell"](https://www.youtube.com/watch?v=OLjTWl4Ci10), which brilliantly distilled decades of marketing psychology into actionable frameworks for AI builders.

### The 5 Books That Power This Plugin

- **Breakthrough Advertising** by Eugene Schwartz — The Bible of direct response marketing
- **Influence: The Psychology of Persuasion** by Robert Cialdini — Cited 100,000+ times
- **Yes! 50 Scientifically Proven Ways to Be Persuasive** by Cialdini, Goldstein & Martin
- **Take Their Money** by Kyle Milligan — Modern copywriting for the internet age
- **The One Sentence Persuasion Course** by Blair Warren — How movements are built

### Built With AI

All code and documentation in this project were generated by [Claude Code](https://claude.ai/code) powered by Claude Opus 4.5. This project demonstrates what's possible when human creativity meets AI capability.
